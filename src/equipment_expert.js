...
const json = __importStar(require("../db/equipment_expert.json"));
...
class EquipmentExpert extends expert_trader_1.ExpertTrader {
    ...
    createAssortTable() {
        ...
        for (const key in this.tables.templates.items) {
            ...
            if (parent != constants_1.ItemParent.Vest &&
                parent != constants_1.ItemParent.Backpack &&
                parent != constants_1.ItemParent.Armor &&
                parent != constants_1.ItemParent.ArmBand &&
                parent != constants_1.ItemParent.Visors &&
                parent != constants_1.ItemParent.FaceCover &&
                parent != constants_1.ItemParent.ArmoredEquipment &&
                parent != constants_1.ItemParent.Headwear &&
                parent != constants_1.ItemParent.Headphones &&
                parent != constants_1.ItemParent.SimpleContainer &&
                parent != constants_1.ItemParent.LockableContainer &&
                parent != constants_1.ItemParent.MobContainer)
                continue;
