...
const json = __importStar(require("../db/medical_expert.json"));
...
class MedicalExpert extends expert_trader_1.ExpertTrader {
    ...
    createAssortTable() {
        ...
        for (const key in this.tables.templates.items) {
            ...
            if (parent != constants_1.ItemParent.Drink &&
                parent != constants_1.ItemParent.Food &&
                parent != constants_1.ItemParent.Stimulator &&
                parent != constants_1.ItemParent.Medical &&
                parent != constants_1.ItemParent.MedKit &&
                parent != constants_1.ItemParent.Drugs &&
                parent != constants_1.ItemParent.Keycard &&
                parent != constants_1.ItemParent.KeyMechanical &&
                parent != constants_1.ItemParent.PortableRangeFinder &&
                parent != constants_1.ItemParent.RepairKits &&
                parent != constants_1.ItemParent.Compass &&
                parent != constants_1.ItemParent.Map)
                continue;
